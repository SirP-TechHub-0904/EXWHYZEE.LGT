...
namespace EXWHYZEE.LGT.Areas.AdminPage.Pages.Users
{
    ...
    [AllowAnonymous]
    public class UpdateParameterModel : PageModel
    {
        ...
        {
            var LGAsC = await _context.LocalGovernments
                                                .Include(x => x.State)
                                                .Where(x=>x.Name == "DEMO")
        ...
        public string AddColor(string name)
        {
            ...
            name = name.ToLower();
            if (name.Substring(2, 1) == "a")
            {
                return a;
            }
            else if (name.Substring(2, 1) == "b")
            {
                return b;
            }
            else if (name.Substring(2, 1) == "c")
            {
                return c;
            }
            else if (name.Substring(2, 1) == "d")
            {
                return d;
            }
            else if (name.Substring(2, 1) == "e")
            {
                return e;
            }
            else if (name.Substring(2, 1) == "f")
            {
                return f;
            }
            else if (name.Substring(2, 1) == "g")
            {
                return g;
            }
            else if (name.Substring(2, 1) == "h")
            {
                return h;
            }
            else if (name.Substring(2, 1) == "i")
            {
                return i;
            }
            else if (name.Substring(2, 1) == "j")
            {
                return j;
            }
            else if (name.Substring(2, 1) == "k")
            {
                return k;
            }
            else if (name.Substring(2, 1) == "l")
            {
                return l;
            }
            else if (name.Substring(2, 1) == "m")
            {
                return m;
            }
            else if (name.Substring(2, 1) == "n")
            {
                return n;
            }
            else if (name.Substring(2, 1) == "o")
            {
                return o;
            }
            else if (name.Substring(2, 1) == "p")
            {
                return p;
            }
            else if (name.Substring(2, 1) == "q")
            {
                return q;
            }
            else if (name.Substring(2, 1) == "r")
            {
                return r;
            }
            else if (name.Substring(2, 1) == "s")
            {
                return s;
            }
            else if (name.Substring(2, 1) == "t")
            {
                return t;
            }
            else if (name.Substring(2, 1) == "u")
            {
                return u;
            }
            else if (name.Substring(2, 1) == "v")
            {
                return v;
            }
            else if (name.Substring(2, 1) == "w")
            {
                return w;
            }
            else if (name.Substring(2, 1) == "x")
            {
                return x;
            }
            else if (name.Substring(2, 1) == "y")
            {
                return y;
            }
            else if (name.Substring(2, 1) == "z")
            {
                return z;
            }
